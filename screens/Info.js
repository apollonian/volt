    ...
    return (
      <View>
        ...
        <Text>
          ...
          RIDESHARE (click here for map) Dropoff will be on Dikeman St. between
          Ferris &amp; Conover St. There will be no parking or long waiting area
          for rideshare cars. All traffic must keep moving. SHUTTLE BUS (click
          here for map) Barclays Center: Guest pick-up is at the bus load in
          area on Flatbush. Carroll Gardens: Guest pick-up is on the corner of
          Smith St / 2nd Place. DROP-OFF / PICK UP AREA at VENUE: The bus
          drop-off pick up area at the venue is closest to e1 entrance. If you
          have tickets, proceed to the gate. If you need tickets, proceed to the
          ticket booth at Ferris &amp; Dikeman. Buses will run continuously
          ...
          (click here for map) There is a free bicycle valet at 202 Coffey
          Street. Please make sure you take proper care around event traffic.
          Bicycles can not be left overnight. CITIBIKE The Citibike station on
          Conover and Coffey street will be attended in order to allow more
          guests to ride Citibikes to the event. Please note this station is the
          only attended Citibike station. PUBLIC BUS The B61 public bus route
          takes you through Red Hook to downtown Brooklyn (click here for
          inbound map) or to Park Slope (click here for outbound map)
        </Text>
        <Text>FAQ</Text>
        <Text>
          1. Can we bring food or drinks in the site? Bringing your own
          consumption is not permitted on the Hydro-Québec Montréal ePrix site.
          2. Can we bring our own chair? To allow everyone to equally enjoy
          their experience, we do not allow anyone to bring their own chair. 3.
          Can we re-enter the site if we have exited it? Yes. Your pass is valid
          for goings and comings. Yes. Every stand seat is reserved. Your seat
          number is written on your ticket. 4. Are stands seats reserved? 5. Can
          we watch the race from the eVillage and the activities zones? Screens
          will be installed to allow everyone in the activities zones to follow
          the race. You can also directly see the circuit from three of the five
          activities zones. 6. Is there a designated seating area for people
          with reduced mobility? a. A section for people with reduced mobility
          is at the junction betweet De la Gauchetière and Berri since the
          closest metro exit (station Berri-UQAM) has an elevator. 7. Can my
          child get in the ePrix site without a ticket? Children aged 5 and over
          need to have a ticket. Children aged 4 and under accompanied by an
          adult do not need a ticket. For assigned seats, the child needs to sit
          on the accompanying adult. 8. I am a resident, business owner or I
          work in the race’s area, where can I know how I will be affected by
          the ePrix? All decisions regarding the residents, the circuit, the
          traffic and the streets are made by the Ville-Marie borough. They will
          keep you informed until the ePrix. You can also contact them by phone
          by dialling 311 or by e-mail at formule-e@ville.montreal.qc.ca ABOUT
          FORMULA E 1. Why are the Formula E races directly in the streets in
          the middle of the cities? Formula E believes that cities are the
          natural environment of electric cars and that having the races on
          street circuits in the middle of the city will promote the use and
          increase the popularity of electric vehicles. 2. How loud is a Formula
          E car? Formula E’s cars are hardly louder than an average gasoline
          powered car (80 dB for 70 dB respectively) and the futurist noise they
          make come from their tires on the circuit, their aerodynamics and
          their electric drivetrain. 3. Why do drivers change cars during the
          race? Why not simply change the battery? Drivers have to change cars
          during the race because today’s electric technology doesn’t allow a
          car to go full speed for an hour. One of the purposes of Formula E is,
          in fact, to accelerate the development of battery technologies and
          electric drivetrains. As for not changing the battery instead of the
          car, for safety reasons it is not allowed to swap car batteries during
          a race. In order to respect the FIA’s safety norms, the batteries are
